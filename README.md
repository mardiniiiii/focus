...
# who made this??
violet made the slack integration and set up the markdown parser
evan the workaround mcp server as our small ollama model did not support it & revamped the UI for tool use
